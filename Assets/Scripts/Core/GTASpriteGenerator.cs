...
public static class GTASpriteGenerator
{
    ...
    private static Sprite CreateIconSprite(string key)
    {
        ...
        Color baseColor;
        Color roofColor;
        Color shadowColor = new Color(0.15f, 0.15f, 0.15f, 0.5f);

        if (key == "building_house")
        {
            baseColor = new Color(0.45f, 0.35f, 0.28f);
            roofColor = new Color(0.5f, 0.25f, 0.2f);
            SetRect(4, 8, 40, 36, baseColor);
            SetRect(4, 4, 40, 8, roofColor);
            SetRect(18, 28, 12, 16, new Color(0.2f, 0.15f, 0.1f));
            SetRect(8, 14, 8, 10, new Color(0.5f, 0.7f, 0.8f, 0.7f));
            SetRect(32, 14, 8, 10, new Color(0.5f, 0.7f, 0.8f, 0.7f));
            SetRect(6, 36, 8, 8, new Color(0.35f, 0.35f, 0.4f));
            SetRect(6, 34, 8, 4, shadowColor);
        }
        else if (key == "building_shop")
        {
            baseColor = new Color(0.4f, 0.38f, 0.35f);
            roofColor = new Color(0.3f, 0.28f, 0.25f);
            SetRect(2, 4, 44, 40, baseColor);
            SetRect(2, 0, 44, 8, roofColor);
            SetRect(4, 20, 40, 22, new Color(0.3f, 0.5f, 0.5f, 0.5f));
            SetRect(18, 8, 12, 8, new Color(0.6f, 0.5f, 0.3f));
            SetRect(2, 42, 44, 2, shadowColor);
        }
        else if (key == "building_pub")
        {
            baseColor = new Color(0.35f, 0.25f, 0.2f);
            roofColor = new Color(0.25f, 0.2f, 0.18f);
            SetRect(2, 6, 44, 38, baseColor);
            SetRect(2, 2, 44, 8, roofColor);
            SetRect(8, 24, 32, 18, new Color(0.2f, 0.15f, 0.1f));
            SetRect(4, 44, 44, 2, shadowColor);
            SetRect(36, 8, 6, 12, new Color(0.6f, 0.6f, 0.4f, 0.5f));
        }
        else if (key == "building_office")
        {
            baseColor = new Color(0.35f, 0.4f, 0.45f);
            roofColor = new Color(0.25f, 0.3f, 0.35f);
            SetRect(2, 2, 44, 42, baseColor);
            SetRect(2, 0, 44, 6, roofColor);
            for (int row = 0; row < 5; row++)
            {
                for (int col = 0; col < 4; col++)
                {
                    SetRect(6 + col * 10, 10 + row * 8, 8, 6, new Color(0.4f, 0.55f, 0.65f, 0.6f));
                }
            }
            SetRect(18, 30, 12, 14, new Color(0.15f, 0.15f, 0.2f));
        }
        else if (key == "building_warehouse")
        {
            baseColor = new Color(0.38f, 0.38f, 0.35f);
            roofColor = new Color(0.28f, 0.28f, 0.25f);
            SetRect(2, 4, 44, 40, baseColor);
            SetRect(2, 0, 44, 8, roofColor);
            SetRect(8, 20, 14, 20, new Color(0.2f, 0.2f, 0.2f));
            SetRect(28, 20, 14, 20, new Color(0.2f, 0.2f, 0.2f));
            SetRect(20, 30, 8, 10, new Color(0.15f, 0.15f, 0.15f));
            SetRect(2, 42, 44, 2, shadowColor);
        }
        else if (key == "building_church")
        {
            baseColor = new Color(0.45f, 0.45f, 0.48f);
            roofColor = new Color(0.3f, 0.3f, 0.35f);
            SetRect(10, 10, 28, 34, baseColor);
            SetRect(14, 6, 20, 8, roofColor);
            SetRect(20, 0, 8, 10, new Color(0.35f, 0.35f, 0.4f));
            SetRect(18, 30, 12, 14, new Color(0.3f, 0.2f, 0.15f));
            SetRect(4, 40, 40, 4, baseColor);
        }
        else if (key == "building_hospital")
        {
            baseColor = new Color(0.85f, 0.88f, 0.9f);
            roofColor = new Color(0.7f, 0.75f, 0.8f);
            SetRect(2, 4, 44, 40, baseColor);
            SetRect(2, 0, 44, 8, roofColor);
            SetRect(18, 16, 12, 20, new Color(0.5f, 0.7f, 0.8f, 0.6f));
            SetRect(22, 36, 4, 8, new Color(0.2f, 0.2f, 0.2f));
            SetRect(4, 10, 6, 4, new Color(0.8f, 0.2f, 0.2f));
            SetRect(38, 10, 6, 4, new Color(0.8f, 0.2f, 0.2f));
        }
        else if (key == "building_police")
        {
            baseColor = new Color(0.25f, 0.3f, 0.4f);
            roofColor = new Color(0.2f, 0.25f, 0.35f);
            SetRect(2, 4, 44, 40, baseColor);
            SetRect(2, 0, 44, 8, roofColor);
            SetRect(18, 24, 12, 18, new Color(0.15f, 0.15f, 0.2f));
            SetRect(6, 10, 8, 8, new Color(0.3f, 0.5f, 0.7f, 0.6f));
            SetRect(34, 10, 8, 8, new Color(0.3f, 0.5f, 0.7f, 0.6f));
            SetRect(4, 44, 40, 2, shadowColor);
        }
        else if (key == "building_gym")
        {
            baseColor = new Color(0.4f, 0.25f, 0.35f);
            roofColor = new Color(0.3f, 0.18f, 0.28f);
            SetRect(2, 4, 44, 40, baseColor);
            SetRect(2, 0, 44, 8, roofColor);
            SetRect(8, 12, 10, 8, new Color(0.5f, 0.7f, 0.8f, 0.6f));
            SetRect(30, 12, 10, 8, new Color(0.5f, 0.7f, 0.8f, 0.6f));
            SetRect(18, 28, 12, 14, new Color(0.2f, 0.15f, 0.1f));
        }
        else if (key == "building_farm")
        {
            baseColor = new Color(0.5f, 0.4f, 0.3f);
            roofColor = new Color(0.4f, 0.25f, 0.15f);
            SetRect(4, 12, 40, 32, baseColor);
            SetRect(8, 8, 32, 8, roofColor);
            SetRect(16, 28, 16, 16, new Color(0.3f, 0.25f, 0.2f));
            SetRect(6, 40, 10, 4, new Color(0.6f, 0.35f, 0.2f));
        }
        else
        {
            baseColor = new Color(0.4f, 0.38f, 0.35f);
            SetRect(2, 4, 44, 40, baseColor);
            SetRect(4, 16, 12, 12, new Color(0.5f, 0.6f, 0.7f, 0.5f));
            SetRect(32, 16, 12, 12, new Color(0.5f, 0.6f, 0.7f, 0.5f));
            SetRect(20, 28, 8, 14, new Color(0.2f, 0.15f, 0.1f));
        }
